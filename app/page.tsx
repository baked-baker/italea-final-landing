...
import { joinNewsletter, joinWishlist } from '@/app/actions' // Import new Server Actions

export default function Italea() {
...
// Server Action states for the main hero form
const [heroFormState, heroFormAction, isHeroFormPending] = useActionState(joinNewsletter, null)
// Server Action states for the newsletter section
const [newsletterFormState, newsletterFormAction, isNewsletterFormPending] = useActionState(joinNewsletter, null)
// Server Action states for the footer form (wishlist/stay connected)
const [footerFormState, footerFormAction, isFooterFormPending] = useActionState(joinWishlist, null)
...
{ name: "Vegan Sweet Potato Brownie", description: `Fudgy, rich, and secretly packed with plant power — this brownie doesn’t just taste good, it feels good. Made with real sweet potato and zero animal products, it’s got the gooey center and crackly top we all crave… but without the guilt trip. A clean, chocolatey pleasure with soul.<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
{ name: "Double Choco Banana Bread", description: `Deep, rich, and melt-in-your-mouth indulgent — this one’s for the unapologetic cocoa lovers. Think moist banana cake meets dark chocolate obsession, minus the nut drama. Superpower: completely nut-free, so you can love it fearlessly.` },
{ name: "Carrot Banana Bread", description: `A warm, spiced classic gets a plant-based glow-up. The natural sweetness of banana meets soft grated carrot for a cake that’s cozy, moist, and shockingly guilt-free. Superpower: it’s 100% vegan — no eggs, no dairy, no compromise.` },
{ name: "Peanut Crumble Banana Bread", description: `Crunchy, creamy, and packed with peanut flavor, this one delivers all the nostalgia with none of the sugar crash. Sweetened naturally and topped with a golden crumble that’s dangerously good. Superpower: it’s completely sugar-free, without tasting like it.<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
{
...
items: [
{ name: "Nutty Bowl", description: `This bowl doesn’t whisper protein… it shouts it from the rooftops. With a base powered by peanut banana bread and natural yoghurt (dairy or non-dairy depending on your choice), it’s stacked with healthy fats, fibre, and satiety-loving crunch. A great post-workout pick-me-up, or an all-day fuel bowl. Also: crunchy peanut sauce? Life-changing.` },
{
...
name: "Retail Items",
items: [
{ name: "Raw Organic Honey", description: "Unprocessed, enzyme-rich honey from local beekeepers<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly (in moderation)</span>" },
{ name: "Date Syrup", description: "Natural liquid sweetener from premium dates<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly (in moderation)</span>" },
{ name: "Extra Virgin Macadamia Oil", description: "Cold-pressed, heart-healthy cooking oil<span class='block text-xs text-green-600 mt-1'>✅ Keto-Friendly</span><span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>" },
{ name: "Spiced Macadamia Chili Oil", description: "Artisan infused oil with perfect heat balance<span class='block text-xs text-green-600 mt-1'>✅ Keto-Friendly</span><span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>" },
{ name: "Spicy Nuts", description: `These nuts bite back. A fiery mix of seeds, spice, and crunch. Warning: highly snackable, may result in tongue-tingling, endorphin-kicking joy.<span class='block text-xs text-green-600 mt-1'>✅ Keto-Friendly</span><span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
{ name: "GF Caramel Granola", description: `Caramel, but clean. This granola is sweetened naturally, gluten-free, and stupidly addictive. One bite and you'll be sprinkling it on everything—including your life decisions.` },
{ name: "Sugar-Free Muesli", description: `Born in the Swiss Alps but reborn in our Italea kitchen, this naturally sweetened blend of grains, seeds, and fruit is light, clean, and loaded with fiber. Perfect for slow mornings, fast smoothies, or anything in between. No added sugar — because real food knows how to speak for itself.<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
{ name: "Salted Root Crisps", description: `Crunchy, earthy, salty magic. Think cassava, sweet potato, beetroot and friends—air-kissed and sea-salted. Your potato crisps just got schooled.<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
],
},
{
name: "Functional Snacks",
items: [
{ name: "Date & Moringa Protein Bar", description: `The superfood duo you didn’t know you needed. Dates bring the sweetness, moringa brings the ancient magic. Plant-based protein, iron, and good vibes in every bar.<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
{ name: "Nut Butter Energy Balls", description: `One bite, and boom—protein party. These little spheres are smooth, rich, and totally satisfying. Perfect for a 3PM pick-me-up or pre-run mini rocket fuel. May cause energy spikes and smug grins.<span class='block text-xs text-green-600 mt-1'>✅ Keto-Friendly (in moderation)</span><span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
{ name: "GF Muesli Bar", description: `Oaty, nutty, and surprisingly filling. Our take on the classic muesli blend—pressed into an anytime snack bar. It's slow-burning, heart-hugging fuel.<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
{ name: "GF Granola Bar", description: `Crunchy, chewy, and not here to bloat you. Perfect for the gluten-sensitive grazer. This bar delivers clean energy, steady sweetness, and serious crunch without the wheat drama.` },
],
},
{
name: "Smoothies",
items: [
{ name: "Whey Pre-Workout Smoothie", description: `A creamy, clean fuel-up designed to pump you up—not weigh you down. Powered by whey, potassium, slow-release carbs, chia seeds, flax seeds, ashwagandha, and peanut flour. Spoiler alert: You’ll probably PR.<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
{ name: "After Math Post-Workout Smoothie", description: `For when the squats were squatting and your body needs to reboot. This smoothie is a muscle-soothing, inflammation-fighting, protein-packing thank-you note to your body, now with added chia seeds, flax seeds, ashwagandha, and peanut flour for enhanced recovery.<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
{ name: "All-in-One Breakfast Smoothie", description: `No time? No problem. This smoothie is the morning multitasker—protein, fiber, fruits, and flair in one go. Basically a balanced breakfast wearing sunglasses.<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
],
},
{
name: "Breads",
items: [
{ name: "Garlic & Olive Focaccia", description: `A nod to the rustic kitchens of Italy, our focaccia is soft, herby, and generously laced with roasted garlic and olives. It’s got that perfect chew and golden crust that begs to be dipped, torn, or devoured as-is. Tradition baked with a little extra soul.` },
{ name: "GF Multi Seed Bread", description: `This loaf doesn’t come to play. Made for the gluten-sensitive and the gut-respecting, it’s nutty, dense, and deeply satisfying. Packed with omega-rich seeds and no fluff (literally), it’s bread with benefits.<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
],
},
{
name: "Sides",
items: [
{ name: "Beetroot Hummus", description: `Bold. Earthy. Beautiful. This magenta goddess is more than a pretty face—packed with fiber, folate, and anti-inflammatory beet power. Great for your gut, your glow-up, and your Instagram feed.<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
{ name: "Coriander Dip", description: `Green, clean, and packing a zing! This herby number brings freshness to any bowl or plate. Coriander is great for digestion and detox, but let’s be honest—you’re here for the flavor kick.<span class='block text-xs text-green-600 mt-1'>✅ Keto-Friendly (with dairy-free yogurt)</span><span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
{ name: "Tamarind Dip", description: `Tangy, sticky, sassy. A flavor slap in the best way possible. Tamarind is packed with antioxidants and natural digestive enzymes. Pairs best with bold tastebuds and good vibes.<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>` },
],
},
{
name: "Probiotics & Gut Health",
items: [
{ name: "Fermented Cabbage", description: "Traditional lacto-fermented cabbage rich in beneficial probiotics<span class='block text-xs text-green-600 mt-1'>✅ Keto-Friendly</span><span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>" },
{ name: "Kimchi", description: "Spicy Korean fermented vegetables packed with gut-friendly bacteria<span class='block text-xs text-green-600 mt-1'>✅ Keto-Friendly</span><span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>" },
{ name: "Kefir Milk", description: "Creamy cultured milk drink teeming with diverse probiotic strains<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly</span>" },
{
name: "Honey Infused Greek Yogurt",
description: "Rich Greek yogurt enhanced with raw honey and live cultures<span class='block text-xs text-green-600 mt-1'>✅ Diabetic-Friendly (in moderation)</span>",
},
],
},
]
...
<ScrollReveal>
  ...
  <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
    Whether you’re watching carbs, lactose intolerant, allergic to gluten or minding sugar, Italea offers snacks that love you back. Explore our Keto-Friendly, Gluten-Free, and Diabetic-Friendly options — clean, conscious, and full of flavor.
  </p>
</ScrollReveal>
</div>
</section>
    ...
    {[
      ...
      <motion.div key={index} className="text-center" whileHover={{ y: -5 }} transition={{ duration: 0.3 }}>
        <motion.div
          ...
          className="inline-block"
        >
          <item.icon className="w-6 h-6 mx-auto mb-3 text-amber-500" aria-hidden="true" />
        </motion.div>
...
<ScrollReveal delay={0.4}>
  <div className="text-center">
    ...
    >
      ...
      <form action={footerFormAction} className="flex gap-2">
