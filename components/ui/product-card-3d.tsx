...
const getProductImage = (productName: string) => {
  switch (productName) {
    ...
    case "GF Caramel Granola":
      return "/images/granola-pouch-display.png"
    case "Sugar-Free Muesli":
      return "/images/italea-muesli-delight.png"
    ...
    case "GF Multi Seed Bread":
      return "/images/rustic-multiseed-bread-loaf.png"
